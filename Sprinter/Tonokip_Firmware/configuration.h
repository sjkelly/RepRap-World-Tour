...
long max_acceleration_units_per_sq_second = 250; // Max acceleration in mm/s^2 for printing moves
long max_travel_acceleration_units_per_sq_second = 250; // Max acceleration in mm/s^2 for travel moves
#endif
